...
// Replace using regex
const regex = /<span className="text-slate-500 block">Pendidikan<\/span>[\s\S]*?<p className="text-slate-600 mt-1">\{f\.kompetensi\}<\/p>\s*<\/div>/g

const replacement = `<span className="text-slate-500 block">Jabatan Akademik / Fungsional</span>
