...
// The submitLaporanKegiatan function starts at export async function submitLaporanKegiatan(fasilitatorId: string, data: any) {
// and ends with `revalidatePath('/dashboard-rab'); return laporan; }`

const startStr = "export async function submitLaporanKegiatan(fasilitatorId: string, data: any) {";
const endStr = "  return laporan;\n}";
