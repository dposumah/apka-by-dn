      ...
      <div>
        ...
        {fasilitator.lokasiSNT ? (
            <div className="mt-3 inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-blue-50 border border-blue-200 text-blue-700 font-medium">
              Lokasi SNT: <span className="font-bold">{fasilitator.lokasiSNT.split(' - ').length > 1 ? `${fasilitator.lokasiSNT.split(' - ')[1]}, ${fasilitator.lokasiSNT.split(' - ')[0]}` : fasilitator.lokasiSNT.split(' - ')[0]}</span>
            </div>
          ) : (
