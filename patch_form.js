...
const startSubmit = "const handleSubmit = async (e: React.FormEvent) => {";
const endSubmit = "setSaving(false)\n    }\n  }";

const startIndex = code.indexOf(startSubmit);
const endIndex = code.indexOf(endSubmit, startIndex) + endSubmit.length;
...
console.log('Fixed client-form.tsx completely');
